 ...
 * @author Pedro Luis
 */
public class Game_Icons extends JFrame implements KeyListener, ActionListener {
    ...
    public Game_Icons() throws Exception{
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Tipo de movimiento de caperucita
        if(modo == 0){
        ...
        for (IGameObject gObj : gObjs) {
            ...
            //Hacemos que las arañas se dirigan hacia caperucita
    ...
    */    
    ...
    //Método para identificar cada objeto del fichero y devolverlo
    ...
    */
    ...
    //Dependiendo de la pantalla en la que se encuentre, aparecen flees, bees o spiders, a parte de blossoms
