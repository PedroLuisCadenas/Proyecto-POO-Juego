 ...
 * @author Pedro Luis
 */
public class Game_Boxes_Precarga extends JFrame implements KeyListener, ActionListener {
    ...
    public Game_Boxes_Precarga() throws Exception{

       super("Game_Boxes_Precarga");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        //Añadimos más personajes dependiendo de la pantalla en la que nos encontremos
        añadirMasEnemigosPorPantalla(screenCounter);
    ...
    */
    private void loadNewBoard(int counter){
        ...
        //Limpiamos la lista de objetos actuales
        gObjs.clear();
        
        //Cargamos el tablero basandonos en el contador de la pantalla por la que va el juego
        loadBoardFromJSON("screen" + counter + ".json");
        
        //Añadimos a caperucita a la lista de objetos
        gObjs.add(ridingHood);
        
    }
    
    private void loadBoardFromJSON(String fichero) {
    try {
        // Leemos el fichero JSON
        JSONArray jsonString = FileUtilities.readJsonsFromFile("src/main/resources/" + fichero);
    ...
    private void añadirMasEnemigosPorPantalla(int screenNumber) {
    // Añadimos más enemigos en función de la pantalla en la que nos encontremos
    ...
    public static void main(String [] args) throws Exception{
       Game_Boxes_Precarga gui = new Game_Boxes_Precarga();       
    }
}
