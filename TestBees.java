...
//Clase de prueba de los movimientos del objeto bee
public class TestBees extends JFrame implements KeyListener, ActionListener {
    ...
    public TestBees() throws Exception{
    ...
    private void loadNewBoard(int counter){
        switch(counter){
            case 0: 
              ...
              gObjs.add(new Bee(new Position(8,2), 4, 10, gObjs));
              break;
            case 1:
