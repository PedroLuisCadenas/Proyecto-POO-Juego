...
//Clase de prueba de los movimientos del objeto spider
public class TestSpider extends JFrame implements KeyListener, ActionListener {
    ...
    public TestSpider() throws Exception{
    ...
    private void loadNewBoard(int counter){
        switch(counter){
            case 0: 
              ...
              gObjs.add(new Spider(new Position(8,2), 4, 10));
              break;
            case 1:
