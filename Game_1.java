...
public class Game_1 extends JFrame implements KeyListener, ActionListener {
    ...
    public void actionPerformed (ActionEvent ae) {
        ...
        //Recorremos la lista hasta encontrar una mosca y si su posición coincide con la de caperucita, le restamos una vida y eliminamos la mosca
        for (IGameObject gObj : gObjs){
            if (gObj instanceof Fly fly){
                if(fly.getPosition() == ridingHood.getPosition()){
